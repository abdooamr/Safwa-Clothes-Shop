      ...
      <ul class="navbar-nav mr-auto">
       ...
       <a class="nav-link" href="../../index.php">El Safwa
        ...
        <li class="nav-item">
          ...
          echo "<a class='nav-link' href='../../products&orders/products.php'>Start an Order</a>";
          echo "</li>
                       <li class='nav-item'>"; 
          echo "<a class='nav-link' href='../../products&orders/myorders.php'>My Orders</a>";
           $UserObject=new User($_SESSION["UserID"]);
          if($UserObject->UserType_obj->UserTypeName=="Admin"){
         echo"  <li class='nav-item'> <a class='nav-link' href='../admin/admin_panel_users.php'>Admin Panel</a>";
}
           }?>
        </li>
